...
class Home extends Component {
  ...
  getVideos = async () => {
    ...
    const url = `https://apis.ccbp.in/videos/all?search=${searchUserInput}`
    const options = {
      headers: {
  ...
  onRetry = () => {
    this.setState({searchUserInput: ''}, this.getVideos)
  }
  ...
  render() {
    const {searchUserInput, bannerDisplay} = this.state
    return (
